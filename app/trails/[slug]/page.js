    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <section style={{ background: '#1c1a17', padding: '72px 24px 56px', borderBottom: '1px solid var(--border)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
          <div style={{ fontSize: 10, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--amber)', marginBottom: 14, fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 24px 0' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: 48, alignItems: 'start' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            {trail.curator_note && (
              <div style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', borderLeft: '3px solid var(--amber)', borderRadius: 3, padding: '20px 24px' }}>
                <div style={{ fontSize: 10, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--amber)', fontFamily: 'var(--font-sans)', marginBottom: 8 }}>Curator's note</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 24, padding: '32px 0', borderTop: '1px solid var(--border)' }}>
            <div>
              ...
              <div style={{ fontSize: 13, color: 'var(--text-2)', fontFamily: 'var(--font-sans)', lineHeight: 1.5 }}>
                We're building trails across Australia's great craft drink regions.<br />
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <Link href="/map" style={{ display: 'inline-block', padding: '11px 24px', background: 'var(--amber)', color: 'var(--bg)', textDecoration: 'none', fontSize: 12, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', fontFamily: 'var(--font-sans)', borderRadius: 2 }}>
                Explore the Map →
              </Link>
            </div>
          </div>
...
function StopCard({ stop, index, isLast }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 16, position: 'relative' }}>
      ...
      <div style={{ flexShrink: 0, width: 40, height: 40, borderRadius: '50%', background: 'var(--amber)', color: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: 14, zIndex: 1, marginTop: 4, fontFamily: 'var(--font-sans)' }}>
        {index + 1}
      </div>
      <div style={{ flex: 1, background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 3, overflow: 'hidden' }}>
        ...
        <div style={{ padding: '16px 20px' }}>
          ...
          <a href={`/venue/${venue.slug}`} style={{ display: 'inline-block', marginTop: 12, fontSize: 11, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--amber)', textDecoration: 'none', fontFamily: 'var(--font-sans)' }}>View listing →</a>
        </div>
      </div>
    </div>
  )
