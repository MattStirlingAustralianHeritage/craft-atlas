      ...
      {!isLoading && venues.length > 0 && (
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '32px 24px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '20px' }}>
            {venues.map(venue => {
              const typeColor = { ceramics_clay: '#C1603A', visual_art: '#7A8C7E', jewellery_metalwork: '#C49A3C', textile_fibre: '#8B6B8A', wood_furniture: '#8A7055', glass: '#5A8A9A', printmaking: '#6B7A5A', leathermaker: '#8A5A3C', shoemaker: '#5F4339', clothing: '#B0736E' }[venue.type] || '#C1603A'
              const typeLabel = { ceramics_clay: 'Ceramics & Clay', visual_art: 'Visual Art', jewellery_metalwork: 'Jewellery & Metalwork', textile_fibre: 'Textile & Fibre', wood_furniture: 'Wood & Furniture', glass: 'Glass', printmaking: 'Printmaking', leathermaker: 'Leatherwork', shoemaker: 'Shoemaking', clothing: 'Clothing' }[venue.type] || venue.type
              return (
                <div key={venue.id}>
