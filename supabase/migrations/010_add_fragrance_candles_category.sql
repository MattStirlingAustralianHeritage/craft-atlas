-- 010_add_fragrance_candles_category.sql
-- Add a new maker category to Craft Atlas: fragrance_candles (label "Fragrance & Candles").
--
-- Same shape as 008/009: on the live craft-atlas DB the venues primary category
...
alter type public.category add value if not exists 'fragrance_candles';
