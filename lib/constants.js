...
export const PRACTICE_LABEL = {
  ...
  leathermaker: 'Practice',
  shoemaker: 'Practice',
  clothing: 'Practice',
  fragrance_candles: 'Practice',
  knifemaker: 'Practice',
}
...
export const TIERS = {
  ...
  standard: { name: 'Standard', price: 295, features: ['description', 'photos', 'hours', 'booking_link', 'social_links', 'practice_description', 'experiences_and_classes', 'featured_video', 'promotions', 'qr_codes', 'analytics'] },
}
